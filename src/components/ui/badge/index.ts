  ...
  "inline-flex items-center justify-center rounded-md border px-2 py-0.5 text-xs font-medium w-fit whitespace-nowrap shrink-0 [&>svg]:size-3 gap-1 [&>svg]:pointer-events-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive transition-[color,box-shadow] overflow-hidden",
  {
    variants: {
      variant: {
        ...
        strength:
          "border-transparent bg-sphere-strength text-sphere-strength-foreground [a&]:hover:bg-sphere-strength/90",
        ...
        magicDef:
          "border-transparent bg-sphere-magicDef text-sphere-magicDef-foreground [a&]:hover:bg-sphere-magicDef/90",
        agility: "border-transparent bg-sphere-agility text-sphere-agility-foreground [a&]:hover:bg-sphere-agility/90",
        accuracy:
          "border-transparent bg-sphere-accuracy text-sphere-accuracy-foreground [a&]:hover:bg-sphere-accuracy/90",
